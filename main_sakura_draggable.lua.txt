...
function Library.CreateLib(WindowTitle, WindowIcon, ToggleKey)
	...
	sakura.Name = "SakuraBackground"
	sakura.BackgroundTransparency = 1
	sakura.Size = UDim2.fromOffset(220, 220)
	sakura.AnchorPoint = Vector2.new(0.5, 0.5)
	sakura.Position = UDim2.new(0.5, 0, 0.5, 0)
	sakura.Image = "rbxassetid://12172552465"
	sakura.ImageTransparency = 0.15
	sakura.ZIndex = 0
	sakura.Parent = main
